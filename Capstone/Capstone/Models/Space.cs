...
namespace Capstone.Models
{
    public class Space
    {
        ...
        public string MonthAbbreviation(DateTime date) 
        {
        ...
        public override string ToString()
        {
            ...
            {
                return this.Name.PadRight(25) + MonthAbbreviation(this.OpenFrom.Value).PadRight(10) + MonthAbbreviation(this.OpenTo.Value).PadRight(10) + this.DailyRate.ToString("c").PadRight(15) +  this.MaxOccupancy;
            }
